...
class MinistriesControllerTest < ActionController::TestCase
  ...
  test "should create ministry" do
    assert_difference('Ministry.count') do
      post :create, ministry: { children: @ministry.children, description: @ministry.description, name: @ministry.name, worship: @ministry.worship }
    end
  ...
  test "should update ministry" do
    put :update, id: @ministry, ministry: { children: @ministry.children, description: @ministry.description, name: @ministry.name, worship: @ministry.worship }
    assert_redirected_to ministry_path(assigns(:ministry))
  end
