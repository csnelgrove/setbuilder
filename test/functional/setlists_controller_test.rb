...
class SetlistsControllerTest < ActionController::TestCase
  ...
  test "should create setlist" do
    assert_difference('Setlist.count') do
      post :create, setlist: { published: @setlist.published, service_date: @setlist.service_date, user_id: @setlist.user_id }
    end
  ...
  test "should update setlist" do
    put :update, id: @setlist, setlist: { published: @setlist.published, service_date: @setlist.service_date, user_id: @setlist.user_id }
    assert_redirected_to setlist_path(assigns(:setlist))
  end
